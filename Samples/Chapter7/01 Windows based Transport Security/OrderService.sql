...
CREATE LOGIN [VISTA_NOTEBOOK\CreditCardLogin] FROM WINDOWS
GO

--********************************************************************
--*  Grant the CONNECT permission to the other SQL Server instance
--********************************************************************
GRANT CONNECT ON ENDPOINT::OrderServiceEndpoint TO [VISTA_NOTEBOOK\CreditCardLogin]
GO
