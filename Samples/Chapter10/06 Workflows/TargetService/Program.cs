            ...
            using (WorkflowRuntime runtime = new WorkflowRuntime())
            {
                ...
                while (true)
                {
                    ...
                    else
                    {
                        switch (messageType)
                        {
                            case "http://ssb.csharp.at/SSB_Book/c10/RequestMessage":
                                ...
                                try
                                {
                                    WorkflowInstance instance = runtime.CreateWorkflow(typeof(SimpleWorkflowTargetService), wfMessage, conversationGroupID);
                                    instance.Start();
                                }
