...
namespace ServiceBroker.SampleWorkflows
{
    public sealed partial class SimpleWorkflowInitiatorService : SequentialWorkflowActivity
    {
        ...
        private void DisplayBeginDialog_ExecuteCode(object sender, EventArgs e)
        {
            Console.WriteLine("BEGIN DIALOG executed...");
        }

        private void DisplayRequestMessageSent_ExecuteCode(object sender, EventArgs e)
        {
        ...
        private void DisplayResponseMessageReceived_ExecuteCode(object sender, EventArgs e)
        {
