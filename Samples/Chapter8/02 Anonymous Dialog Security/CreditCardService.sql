...
-- Grant the CONTROL permission to the previous created database user
...
-- Create the certificate that represents the CreditCardService
...
-- Backup the public key of the certificate
BACKUP CERTIFICATE CreditCardServiceCertPrivate
	TO FILE = 'c:\CreditCardServiceCertPublic.cert'
GO

-- Grant the SEND permission to the database role [PUBLIC]
