...
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'Chapter11_DatabaseMirroring')
BEGIN
	PRINT 'Dropping database ''Chapter11_DatabaseMirroring''';
	DROP DATABASE Chapter11_DatabaseMirroring;
END
GO

CREATE DATABASE Chapter11_DatabaseMirroring
GO

USE Chapter11_DatabaseMirroring
GO
...
BACKUP CERTIFICATE MirroringCertPrivate
	TO FILE = 'c:\MirroringCertPrincipalPublic.cert'
GO

--***************************************************
--*  Add the login for the other mirroring database
--***************************************************
CREATE LOGIN MirrorLogin WITH PASSWORD = 'password1!'
GO
...
--***********************************************************************
CREATE CERTIFICATE MirroringCertPublic
	AUTHORIZATION MirrorUser
	FROM FILE = 'c:\MirroringCertMirrorPublic.cert'
GO
...
--**********************************
--*  Doing a full database backup.
--**********************************
BACKUP DATABASE [Chapter11_DatabaseMirroring] 
	TO DISK = 'd:\Chapter11_DatabaseMirroring.bak' 
	WITH NOFORMAT, NOINIT,  
	NAME ='Chapter11_DatabaseMirroring-Full Database Backup', 
...
--*  Doing a log backup.
--************************
BACKUP LOG Chapter11_DatabaseMirroring
	TO DISK = 'd:\Chapter11_DatabaseMirroringLog.bak'
GO

--********************************************
--*  Setting the database mirroring partner.
--********************************************
ALTER DATABASE Chapter11_DatabaseMirroring
SET PARTNER = 'TCP://MirrorInstance:4740'
GO
