...
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'Chapter11_OrderService')
BEGIN
	PRINT 'Dropping database ''Chapter11_OrderService''';
	DROP DATABASE Chapter11_OrderService;
END
GO

CREATE DATABASE Chapter11_OrderService
GO

USE Chapter11_OrderService
GO
...
--***********************************************************
GRANT CONNECT ON ENDPOINT::OrderServiceEndpoint TO MessageForwardingServiceLogin
GO
