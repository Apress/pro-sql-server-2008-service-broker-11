...
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'Chapter11_LoadBalancedOrderService2')
BEGIN
	PRINT 'Dropping database ''Chapter11_LoadBalancedOrderService2''';
	DROP DATABASE Chapter11_LoadBalancedOrderService2;
END
GO

CREATE DATABASE Chapter11_LoadBalancedOrderService2
GO

USE Chapter11_LoadBalancedOrderService2
GO
...
BACKUP CERTIFICATE OrderServiceCertPrivate
	TO FILE = 'c:\OrderServiceCertPublic2.cert'
GO
