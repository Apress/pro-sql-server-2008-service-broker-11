...
namespace ProcessingApplication2
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			while (true)
			{
				...
				broker.Receive("TargetQueue2", out msgType, out msg, out serviceInstance, out dialogHandle);
				...
				switch (msgType)
				{
					case "http://ssb.csharp.at/SSB_Book/c04/RequestMessage":
						{
							broker.Send(dialogHandle, "<Response>This is the response message from the external activated C# program #2...</Response>");
							break;
						}
